...
export const I18N: Record<Lang, Dict> = {
  en: {
    ...
    transfer_all_title: "Transfer your whole collection",
    transfer_all_note: "Sends every Taigaz you own to another wallet in a single transaction. This cannot be undone.",
    transfer_to_placeholder: "Recipient wallet (0x…)",
    transfer_bad_addr: "Enter a valid 0x wallet address.",
    transfer_same_addr: "That's your own address.",
    transfer_none: "You have no Taigaz to transfer.",
    transfer_confirm: "Transfer {0} Taigaz",
    transferring: "Transferring…",
    transfer_done: "✅ Transferred {0} Taigaz",
  ...
  fr: {
    ...
    transfer_all_title: "Transférer toute ta collection",
    transfer_all_note: "Envoie toutes tes Taigaz vers un autre wallet en une seule transaction. Action irréversible.",
    transfer_to_placeholder: "Wallet destinataire (0x…)",
    transfer_bad_addr: "Saisis une adresse wallet 0x valide.",
    transfer_same_addr: "C'est ta propre adresse.",
    transfer_none: "Tu n'as aucune Taigaz à transférer.",
    transfer_confirm: "Transférer {0} Taigaz",
    transferring: "Transfert…",
    transfer_done: "✅ {0} Taigaz transférées",
